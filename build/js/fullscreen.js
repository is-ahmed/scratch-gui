...
/******/ 		return __webpack_require__.p + "js/" + ({"addon-settings~addons":"addon-settings~addons","addons":"addons","library-backdrops":"library-backdrops","library-costumes":"library-costumes","library-sounds":"library-sounds","library-sprites":"library-sprites"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/******/ 	deferredModules.push(["./src/playground/fullscreen.jsx","vendors~addon-settings~credits~editor~embed~fullscreen~player","vendors~editor~embed~fullscreen~player","editor~embed~fullscreen~player","addon-settings~editor~fullscreen~player"]);
...
}, instructions === 'unshared' && credits === 'unshared' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
...
StudioView.STUDIO_API = 'https://trampoline.turbowarp.org/proxy/studios/$id/projectstemporary/$offset'; // The URL to download thumbnails from.
// $id is replaced with the project's ID.

StudioView.THUMBNAIL_SRC = 'https://cdn2.scratch.mit.edu/get_image/project/$id_144x108.png'; // The URL for project pages.
  ...
  class ProjectMetaFetcherComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
    ...
    componentDidUpdate() {
      ...
      fetchProjectMeta(projectId).then(data => {
        ...
        setIndexable(views >= 50 && loves >= 5 && favorites >= 5);
      }).catch(err => {
        setIndexable(false);
...
/* harmony default export */ __webpack_exports__["default"] = (loadServiceWorker);
...
/* harmony import */ var _lib_tw_stage_size__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../lib/tw-stage-size */ "./src/lib/tw-stage-size.js");
...
const WrappedMenuBar = Object(redux__WEBPACK_IMPORTED_MODULE_4__["compose"])(_lib_sb_file_uploader_hoc_jsx__WEBPACK_IMPORTED_MODULE_13__["default"])(_components_menu_bar_menu_bar_jsx__WEBPACK_IMPORTED_MODULE_18__["default"]);
...
Promise.all(/*! import() | addons */[__webpack_require__.e("addon-settings~addons"), __webpack_require__.e("addons")]).then(__webpack_require__.bind(null, /*! ../addons/entry */ "./src/addons/entry.js"));
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.isLoading && !this.props.isLoading) {
      Object(_load_service_worker__WEBPACK_IMPORTED_MODULE_27__["default"])();
    }
  }
  ...
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      style: isPlayerOnly ? {
        ...
        width: "".concat(Math.max(480, _lib_tw_stage_size__WEBPACK_IMPORTED_MODULE_15__["default"].width) + 2, "px")
      } : null
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_tw_project_input_project_input_jsx__WEBPACK_IMPORTED_MODULE_19__["default"], null)), hasCloudVariables && projectId !== '0' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: _interface_css__WEBPACK_IMPORTED_MODULE_28___default.a.section
