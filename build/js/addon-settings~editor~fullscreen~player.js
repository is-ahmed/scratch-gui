...
/*!**************************************************!*\
  !*** ./src/addons/addons/bitmap-copy/addon.json ***!
  \**************************************************/
/*! exports provided: name, description, info, userscripts, dynamicEnable, dynamicDisable, versionAdded, tags, permissions, enabledByDefault, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"Bitmap images copying\",\"description\":\"Allows you to actually copy a bitmap image from the paint editor, so that you can paste it in other websites or software.\",\"info\":[{\"type\":\"notice\",\"text\":\"\\\"Right click → copy\\\" is not supported. You must press Ctrl+C while a bitmap image is selected.\",\"id\":\"norightclick\"}],\"userscripts\":[{\"url\":\"userscript.js\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"dynamicEnable\":true,\"dynamicDisable\":true,\"versionAdded\":\"1.0.0\",\"tags\":[\"editor\",\"costumeEditor\"],\"permissions\":[\"clipboardWrite\"],\"enabledByDefault\":true}");
...
/*!***************************************************!*\
  !*** ./src/addons/addons/color-picker/addon.json ***!
  \***************************************************/
/*! exports provided: name, description, tags, credits, userscripts, userstyles, dynamicEnable, dynamicDisable, versionAdded, libraries, enabledByDefault, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"Hex color picker\",\"description\":\"Adds hex code inputs to color pickers.\",\"tags\":[\"editor\",\"costumeEditor\",\"recommended\"],\"credits\":[{\"name\":\"Richie Bendall\"},{\"name\":\"apple502j\"}],\"userscripts\":[{\"url\":\"userscript.js\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"userstyles\":[{\"url\":\"style.css\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"dynamicEnable\":true,\"dynamicDisable\":true,\"versionAdded\":\"1.6.0\",\"libraries\":[\"tinycolor2\"],\"enabledByDefault\":true}");
...
/*!************************************************!*\
  !*** ./src/addons/addons/drag-drop/addon.json ***!
  \************************************************/
/*! exports provided: name, description, credits, userscripts, userstyles, dynamicEnable, dynamicDisable, versionAdded, tags, enabledByDefault, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"Drag and drop files\",\"description\":\"Lets you drag images and sounds from your file explorer into the sprites pane or costume/sound list. You can also drag text files into lists or \\\"ask and wait\\\" prompts.\",\"credits\":[{\"name\":\"Sheep_maker\"}],\"userscripts\":[{\"url\":\"userscript.js\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"userstyles\":[{\"url\":\"dragged-over.css\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"dynamicEnable\":true,\"dynamicDisable\":true,\"versionAdded\":\"1.12.0\",\"tags\":[\"editor\",\"recommended\"],\"enabledByDefault\":true}");
...
/*!******************************************************************!*\
  !*** ./src/addons/addons/editor-searchable-dropdowns/addon.json ***!
  \******************************************************************/
/*! exports provided: name, description, credits, dynamicEnable, dynamicDisable, userscripts, userstyles, versionAdded, tags, enabledByDefault, enabledByDefaultMobile, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"Searchable dropdowns\",\"description\":\"Allows you to search dropdowns in the Scratch editor.\",\"credits\":[{\"name\":\"GarboMuffin\"}],\"dynamicEnable\":true,\"dynamicDisable\":true,\"userscripts\":[{\"url\":\"userscript.js\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"userstyles\":[{\"url\":\"userscript.css\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"versionAdded\":\"1.0.0\",\"tags\":[\"editor\",\"codeEditor\",\"recommended\"],\"enabledByDefault\":true,\"enabledByDefaultMobile\":false}");
...
/*!**********************************************!*\
  !*** ./src/addons/addons/gamepad/addon.json ***!
  \**********************************************/
/*! exports provided: name, description, credits, userscripts, userstyles, settings, tags, enabledByDefault, versionAdded, dynamicEnable, dynamicDisable, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"Gamepad support\",\"description\":\"Interact with projects using a USB or Bluetooth controller/gamepad.\",\"credits\":[{\"name\":\"GarboMuffin\"}],\"userscripts\":[{\"url\":\"userscript.js\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"userstyles\":[{\"url\":\"style.css\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]},{\"url\":\"gamepadlib.css\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"settings\":[{\"name\":\"Hide settings button when no controllers detected\",\"type\":\"boolean\",\"default\":false,\"id\":\"hide\"}],\"tags\":[\"editor\",\"projectPlayer\",\"recommended\"],\"enabledByDefault\":false,\"versionAdded\":\"1.14.0\",\"dynamicEnable\":true,\"dynamicDisable\":true}");
...
/*!************************************************************!*\
  !*** ./src/addons/addons/remove-sprite-confirm/addon.json ***!
  \************************************************************/
/*! exports provided: name, description, userscripts, dynamicEnable, dynamicDisable, versionAdded, tags, enabledByDefault, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"Confirm sprite deletion\",\"description\":\"Asks if you're sure when deleting a sprite inside a project.\",\"userscripts\":[{\"url\":\"userscript.js\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"dynamicEnable\":true,\"dynamicDisable\":true,\"versionAdded\":\"1.0.0\",\"tags\":[\"editor\",\"recommended\"],\"enabledByDefault\":false}");
...
/*!*****************************************************************!*\
  !*** ./src/addons/addons/tw-interface-customization/addon.json ***!
  \*****************************************************************/
/*! exports provided: name, description, userscripts, userstyles, settings, tags, enabledByDefault, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"Dangerous customizations\",\"description\":\"Obscure customization options that few people will want to use. Not recommended.\",\"userscripts\":[{\"url\":\"remove-backpack.js\",\"matches\":[\"https://scratch.mit.edu/projects/*\"],\"settingMatch\":{\"id\":\"removeBackpack\",\"value\":true}}],\"userstyles\":[{\"url\":\"remove-backpack.css\",\"matches\":[\"https://scratch.mit.edu/projects/*\"],\"settingMatch\":{\"id\":\"removeBackpack\",\"value\":true}}],\"settings\":[{\"name\":\"Remove backpack\",\"id\":\"removeBackpack\",\"type\":\"boolean\",\"default\":false}],\"tags\":[\"theme\"],\"enabledByDefault\":false}");
...
module.exports = JSON.parse("{\"name\":\"Variable manager\",\"description\":\"Adds a tab next to \\\"sounds\\\" in the editor for easily updating variables and lists.\",\"credits\":[{\"name\":\"Jeffalo\"},{\"name\":\"GarboMuffin\"}],\"userscripts\":[{\"url\":\"userscript.js\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"userstyles\":[{\"url\":\"style.css\",\"matches\":[\"https://scratch.mit.edu/projects/*\"]}],\"dynamicEnable\":true,\"dynamicDisable\":true,\"versionAdded\":\"1.11.0\",\"tags\":[\"editor\",\"recommended\"],\"enabledByDefault\":false}");
...
module.exports = JSON.parse("{\"version\":\"1.17.1-prerelease\",\"commit\":\"e5910af\",\"languages\":[\"de\",\"en\",\"es\",\"fr\",\"it\",\"ja\",\"ko\",\"pl\",\"pt-br\",\"ro\",\"ru\",\"sl\",\"tr\"]}");
